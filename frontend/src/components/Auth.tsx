...
import { SignupInput } from "@amankumar_1229/medium-common";
    ...
    return <div className = "h-screen flex justify-center flex-col">
        <div className = "flex  justify-center">
            <div>
                ...
                <div className = "pt-8">
                    {type === "signup"? <LabelledInput label="Name" placeholder = "Aman Kumar..." onChange = {(e)=>{
                        setPostInputs({
                            ...postInputs,
                            name : e.target.value
                    ...
                    <LabelledInput label="Username" placeholder = "amanks2580@gmail.com" onChange = {(e)=>{
                        setPostInputs({
                            ...postInputs,
                    ...
                    <LabelledInput type = {"password"}label="Password" placeholder = "12345678" onChange = {(e)=>{
                        setPostInputs({
                            ...postInputs,
